...
export const AdminDashboard = ({ currentUser, onNavigate }) => {
  ...
  return (
    <div className="pt-24 px-6 text-white min-h-screen bg-[#050507]">
      <h1 className="text-5xl font-black uppercase italic italic">DevOps <span className="text-blue-500">Master</span></h1>
      <div className="mt-10 bg-[#0F0F11] p-10 rounded-[40px] border border-blue-500/20">
         <h3 className="text-sm font-black uppercase mb-6 tracking-widest text-blue-400">ADN Saneado v21.0</h3>
