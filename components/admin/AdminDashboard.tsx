...
export const AdminDashboard = ({ currentUser, onNavigate }) => {
  ...
  const sync = async () => {
    ...
    alert('Iniciando Mirroring Recursivo v25...');
  };
  return (
    <div className="pt-24 px-6 text-white min-h-screen bg-[#050507] font-sans">
      ...
      <div className="bg-[#0F0F11] p-10 rounded-[40px] border border-blue-500/20 shadow-2xl">
         <h3 className="text-sm font-black uppercase mb-6 tracking-widest text-blue-400">Mirroring Recursivo v25</h3>
         ...
         <button className="w-full py-4 bg-blue-600 rounded-xl font-black uppercase tracking-widest hover:bg-blue-500" onClick={sync}>Sincronizar Producción</button>
      </div>
