        ...
        <div className="min-h-screen bg-[#050507] flex flex-col items-center justify-between p-6 text-white relative overflow-hidden selection:bg-red-600">
            ...
            <div className="relative z-10 pt-10 flex flex-col items-center space-y-6 animate-in fade-in slide-in-from-top-12 duration-1000">
                ...
                <div className="relative group">
                    <div className={`absolute -inset-4 rounded-full blur-2xl transition-all duration-700 animate-pulse ${isAdminMode ? 'bg-red-600/40' : 'bg-white/5 opacity-50'}`}></div>
                    <div className={`relative w-32 h-32 md:w-44 md:h-44 bg-black border-2 rounded-full flex items-center justify-center overflow-hidden transition-all duration-500 shadow-2xl ${isAdminMode ? 'border-red-600' : 'border-white/10'}`}>
                        {/* 
                            SI SUBES TU LOGO AL REPOSITORIO COMO 'logo.png', 
                            descomenta la línea de abajo y borra el div del texto 'K' 
                        */}
                        <img 
                            src="./logo.png" 
                            alt="KINETIX" 
                            className="w-4/5 h-4/5 object-contain opacity-90 group-hover:scale-110 transition-transform duration-700"
                            onError={(e) => {
                        ...
                        <div className="fallback-logo hidden flex flex-col items-center">
                            <span className={`text-6xl md:text-7xl font-black italic tracking-tighter leading-none ${isAdminMode ? 'text-red-600' : 'text-white'}`}>K</span>
                            <div className={`h-1.5 w-10 mt-1 ${isAdminMode ? 'bg-red-600' : 'bg-white/20'}`}></div>
                        </div>
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col items-center">
                        <div className={`h-[2px] w-24 my-3 ${isAdminMode ? 'bg-red-600' : 'bg-white/10'}`}></div>
            ...
            <div className="relative z-10 w-full max-w-lg pb-10 flex flex-col items-center space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-500">
                <div className="flex gap-8 md:gap-12 items-center">
                    ...
                    <a href="https://facebook.com/kinetix.funcionalzone" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2">
                        <div className="w-12 h-12 border border-white/10 rounded-sm flex items-center justify-center bg-white/5 group-hover:bg-[#1877F2] group-hover:border-[#1877F2] group-hover:shadow-[0_0_20px_rgba(24,119,242,0.4)] transition-all duration-300">
                    ...
                    <a href="https://instagram.com/kinetix.funcionalzone" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2">
                        <div className="w-12 h-12 border border-white/10 rounded-sm flex items-center justify-center bg-white/5 group-hover:bg-[#E4405F] group-hover:border-[#E4405F] group-hover:shadow-[0_0_20px_rgba(228,64,95,0.4)] transition-all duration-300">
                    ...
                    <a href="https://wa.me/525627303189" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2">
                        <div className="w-12 h-12 border border-white/10 rounded-sm flex items-center justify-center bg-white/5 group-hover:bg-[#25D366] group-hover:border-[#25D366] group-hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] transition-all duration-300">
                ...
                <div className="flex flex-col items-center gap-4 pt-8 w-full border-t border-white/5">
                    ...
                    <p className="text-[7px] font-black text-white/5 uppercase tracking-[1em] text-center">Military Grade High Performance System</p>
                </div>
            </div>
